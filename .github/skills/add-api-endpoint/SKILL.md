...
4. Apply endpoint-layer validation, validation ProblemDetails rules, and enum query binding — see [validation-and-problemdetails.md](references/validation-and-problemdetails.md).
...
- [validation-and-problemdetails.md](references/validation-and-problemdetails.md) — validation ProblemDetails JSON, .NET 10 automatic validation, `ProducesValidationProblem`, `DisableValidation`, manual validation, and enum query binding.
