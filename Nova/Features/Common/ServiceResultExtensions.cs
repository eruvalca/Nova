            ...
            return problem.Kind switch
            {
                ...
                ServiceProblemKind.Conflict when problem.Errors is { } conflictErrors =>
                    TypedResults.Problem(
                        ...
                        extensions: new Dictionary<string, object?>(extensions, StringComparer.Ordinal) { ["errors"] = conflictErrors }),
                ...
                ServiceProblemKind.Validation =>
                    TypedResults.ValidationProblem(
                        errors: problem.Errors?.ToDictionary(e => e.Key, e => e.Value, StringComparer.Ordinal) ?? [],
                        detail: problem.Detail,
                        extensions: problemExtensions),
