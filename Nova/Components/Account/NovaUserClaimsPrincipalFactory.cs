...
/// <summary>
/// Adds the <see cref="NovaClaimTypes.ClubId"/> and <see cref="NovaClaimTypes.HasProfilePhoto"/>
/// claims (and role claims via the base factory) to the user's principal at sign-in.
