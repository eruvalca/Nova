...
builder.Services.AddScoped<IPlacementContextQueryService, PlacementContextQueryService>();
...
builder.Services.AddScoped<IClubActivityQueryService, ClubActivityQueryService>();
builder.Services.AddScoped<IClubAttentionQueryService, ClubAttentionQueryService>();
builder.Services.AddScoped<ICampaignMetadataService, CampaignMetadataService>();
builder.Services.AddScoped<ISeasonCommandService, SeasonCommandService>();
...
app.MapCampaignCloseoutEndpoints();
