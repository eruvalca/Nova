...
/// <summary>Durable evaluation proof with tenant and actor snapshots and no aggregate foreign keys.</summary>
internal sealed class EvaluationMutationReceiptEntity : BaseEntity, ITenantOwnedEntity
{
    /// <summary>Gets or sets the storage identity.</summary>
    public long EvaluationMutationReceiptId { get; set; }
