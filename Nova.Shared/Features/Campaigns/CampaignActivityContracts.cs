...
/// <param name="ActorDisplayName">The stored actor display-name snapshot taken when the event was written (for example, "Unknown user" when the actor could not be resolved at write time).</param>
