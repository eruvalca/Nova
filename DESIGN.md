...
The evaluation composition and locked comp remain in the [evaluation surface brief](.impeccable/surfaces/evaluation.md) and [approved Shared evidence notebook image](.impeccable/mocks/decision/issue-198-shared-notebook.png). The [issue #198 finish record](.impeccable/review/issue-198/finish-review.md) records all material visual fixes 1–7 resolved, with shared-shell adaptations accepted. After the user-funded correction round, the measured mechanical hero score is **73.43% against 72%**. Fix 8 remains partial because the regional comparison coordinates are misregistered against the preserved shell; the user decision between sheet-relative comparison and a revised reference remains pending. The gate remains open without a waiver, override, or final visual approval. This merge records built visual evidence, not shipment or independent behavioral certification.
