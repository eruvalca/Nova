...
namespace Nova.SharedKernel.Features.Dashboard;
...
public sealed record ActiveCampaignCardDto
{
    ...
    /// </summary>
#pragma warning disable CA1056 // The serialized relative route is bound directly to Razor links and validated by the client.
