...
public static class TeamLifecycleProblemExtensions
{
    ...
    public static IReadOnlyDictionary<string, object?> CreateArchiveBlockerExtensions(
        ...
        => new Dictionary<string, object?>(StringComparer.Ordinal) { [ArchiveBlockersExtensionName] = blockers };
    ...
    public static IReadOnlyDictionary<string, object?> CreateGraduationYearBlockerExtensions(
        ...
        => new Dictionary<string, object?>(StringComparer.Ordinal) { [GraduationYearBlockersExtensionName] = blockers };
...
#pragma warning restore CA1034 // Nested types should not be visible
        ...
        out IReadOnlyList<T> blockers)
    {
        ...
        try
        {
            var parsed = element.Deserialize<List<T>>(JsonSerializerOptions.Web);
            if (parsed is null)
            {
                return false;
            }
