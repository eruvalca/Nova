...
namespace Nova.SharedKernel.Validation;
...
public static class InputValidator
{
    ...
    /// </returns>
#pragma warning disable MA0016 // Callers own and augment these validation errors before passing them to framework APIs.
