...
- **Slice scope:** #255 established the queue/evidence/decision composition. #254 extends it with reassignment, the prior-team fast path, inline confirmation, bounded history, and receipt-based recovery. The same rail-and-sheet composition remains locked; see `docs/issue-254-validation.md`.
