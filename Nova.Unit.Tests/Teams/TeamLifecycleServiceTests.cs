...
public sealed class TeamLifecycleServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task ArchiveAsyncReturnsNotFoundWhenTeamBelongsToOtherClubAsync()
    {
    ...
    [Fact]
    public async Task ArchiveAsyncArchivesTeamAndSetsProvenanceAsync()
    {
        ActAs(ClubAAdminId, ClubAId, isClubAdmin: true);
        var service = CreateService();
    ...
    [Fact]
    public async Task ArchiveAsyncReturnsConflictWhenTeamAlreadyArchivedAsync()
    {
        ActAs(ClubAAdminId, ClubAId, isClubAdmin: true);
        var service = CreateService();
    ...
    [Fact]
    public async Task ArchiveAsyncReturnsConflictWhenActivePlacementRemainsAsync()
    {
        ActAs(ClubAAdminId, ClubAId, isClubAdmin: true);
        var service = CreateService();
    ...
    [Fact]
    public async Task RestoreAsyncRestoresTeamAndClearsProvenanceAsync()
    {
        ActAs(ClubAAdminId, ClubAId, isClubAdmin: true);
        var service = CreateService();
    ...
    [Fact]
    public async Task RestoreAsyncReturnsConflictWhenTeamAlreadyActiveAsync()
    {
        ActAs(ClubAAdminId, ClubAId, isClubAdmin: true);
        var service = CreateService();
