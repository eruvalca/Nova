...
#pragma warning disable CA2213 // The test owns this borrowed response; the handler only returns it to HttpClient.
...
#pragma warning restore CA2213
    ...
    [Fact]
    public async Task GetCampaignListAsyncRequestsSharedRouteAndRespectsQueryAsync()
    {
    ...
    [Fact]
    public async Task GetCampaignListAsyncReturnsServerErrorForEmptySuccessPayloadAsync()
    {
    ...
    [Fact]
    public async Task GetCreationSetupAsyncUsesSetupRouteAndValidatesPayloadAsync()
    {
    ...
    [Fact]
    public async Task GetCampaignListAsyncReturnsProblemFromProblemDetailsAsync()
    {
    ...
    [Fact]
    public async Task GetCampaignListAsyncReturnsServerErrorForMalformedJsonAsync()
    {
    ...
    [Fact]
    public async Task GetCampaignListAsyncReturnsValidationProblemForInvalidInputAsync()
    {
    ...
    [Fact]
    public async Task GetCreationSetupAsyncReturnsServerErrorForInvalidCurrentSeasonAsync()
    {
    ...
    [Fact]
    public async Task GetOpeningReadinessAsyncRequestsSharedRouteAndAcceptsValidPayloadAsync()
    {
    ...
    public async Task GetOpeningReadinessAsyncReturnsServerErrorForInvalidPayloadAsync(string payload)
    {
        using var response = new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = new StringContent(payload, Encoding.UTF8, "application/json")
    ...
    public async Task GetOpeningReadinessAsyncRequiresCompleteBoundedPreviewAsync(int teamCount, int previewCount, bool valid)
    {
        using var response = new HttpResponseMessage(HttpStatusCode.OK)
        {
    ...
    /// </summary>
    [Fact]
    public async Task GetCampaignListAsyncAcceptsPopulatedValidPayloadAsync()
    {
        const string Payload = """
    ...
    [Fact]
    public async Task GetCampaignListAsyncAcceptsDraftLifecycleOrderAsync()
    {
        const string Payload = """
    ...
    [Fact]
    public async Task GetCampaignListAsyncAcceptsCurrentSeasonBeforeNewerHistoryAsync()
    {
        const string Payload = """
    ...
    [Fact]
    public async Task GetCampaignListAsyncReturnsServerErrorForEmptySeasonConcurrencyTokenAsync()
    {
        const string Payload = """
            {"seasons":[{"seasonId":1,"name":"Season","startDate":"2026-01-01","endDate":null,
    ...
    public async Task GetCampaignListAsyncReturnsServerErrorForInvalidPopulatedPayloadAsync(string payload)
    {
        var result = await GetCampaignListFromJsonAsync(payload);
    ...
    /// </summary>
    [Fact]
    public async Task GetCampaignListAsyncReturnsServerErrorForOverLimitPayloadAsync()
    {
        const string Payload = """
    ...
    [InlineData(19)]
    [InlineData(21)]
    public async Task GetCampaignListAsyncRejectsDifferentResponseLimitAsync(int responseLimit)
    {
    ...
    [InlineData(1, "null")]
    public async Task GetCampaignListAsyncRejectsInconsistentClosureMetadataAsync(int status, string closedAt)
    {
        var payload = $$"""
    ...
    public async Task GetCreationSetupAsyncReturnsServerErrorForInvalidPayloadAsync(string payload)
    {
        using var response = new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = new StringContent(payload, Encoding.UTF8, "application/json")
    ...
    public async Task GetCampaignListAsyncRequiresPreviewForDraftRowsAsync(string previewProperty, bool valid)
    {
        var payload = $$"""
    ...
    public async Task GetCampaignListAsyncRejectsMissingPagingMetadataAsync(string payload)
    {
    ...
    [Fact]
    public async Task GetCampaignDetailAsyncRequestsDetailRouteAndParsesPayloadAsync()
    {
    ...
    /// </summary>
    [Fact]
    public async Task GetCampaignDetailAsyncAcceptsPopulatedValidPayloadAsync()
    {
        const string Payload = """
    ...
    /// </summary>
    [Fact]
    public async Task GetCampaignDetailAsyncAcceptsPopulatedClosedPayloadAsync()
    {
        const string Payload = """
    ...
    [Fact]
    public async Task GetCampaignDetailAsyncAcceptsDraftPayloadAsync()
    {
        const string Payload = """
    ...
    public async Task GetCampaignDetailAsyncReturnsServerErrorForInvalidPopulatedPayloadAsync(string payload)
    {
        var result = await GetCampaignDetailFromJsonAsync(payload);
    ...
    [Fact]
    public async Task GetCampaignDetailAsyncReturnsNotFoundFromProblemDetailsAsync()
    {
    ...
    [Fact]
    public async Task GetCampaignDetailAsyncReturnsValidationProblemForInvalidInputAsync()
    {
        using var response = new HttpResponseMessage(HttpStatusCode.OK);
        using var handler = new FakeHttpMessageHandler(response);
        using var http = new HttpClient(handler) { BaseAddress = new Uri("https://localhost/") };
