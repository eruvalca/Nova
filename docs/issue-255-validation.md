...
- the stamped persisted-owner key carrying the lifecycle even when the host supplies only its campaign and
  authority scope, so Active rows can never be restored as Closed
